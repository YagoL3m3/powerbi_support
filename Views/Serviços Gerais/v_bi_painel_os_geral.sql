-- public.v_bi_painel_os_geral source
...
AS SELECT ordsrvi.ordi_tipdeos_1 AS cd_tipo,
    ...
    ordsrvi.ordi_fechinv_1 AS dt_fech,
   ...
   FROM ordsrvi
     ...
     LEFT JOIN apopro p ON ordsrvi.ordi_produti_1 = p.opro_produti_1
     ...
     LEFT JOIN notsais n ON n.tser_numorde_1 = ordsrvi.ordi_nrordem_1 AND n.tser_emitent_1 = ordsrvi.ordi_emitent_1
UNION ALL
 SELECT ordsrvs.ords_tipdeos_1 AS cd_tipo,
    ...
    ordsrv.orde_nomcli1_1 AS nm_clie,
    ordsrv.orde_databer_1 AS dt_aber,
    ordsrvs.ords_fechinv_1 AS dt_fech,
   ...
   FROM ordsrvs
     ...
     LEFT JOIN cadven c ON c.dven_codvend_1 = ordsrv.orde_recepci_1
     LEFT JOIN apopro p ON ordsrvs.ords_produti_1 = p.opro_produti_1
     LEFT JOIN segcad s ON s.gcad_placvei_1::text = ordsrv.orde_placvei_1::text
     LEFT JOIN sintab21 ON sintab21.ntab_codmode_21::text = s.gcad_codmode_1::text
     ...
     LEFT JOIN notsais n ON n.tser_numorde_1 = ordsrvs.ords_nrordem_1 AND n.tser_emitent_1 = ordsrvs.ords_emitent_1
UNION ALL
 SELECT ordsrv.orde_tipdeos_1 AS cd_tipo,
    ...
    ordsrv.orde_nomcli1_1 AS nm_clie,
    ordsrv.orde_databer_1 AS dt_aber,
    ordsrv.orde_fechinv_1 AS dt_fech,
    0 AS nr_nota,
   ...
   FROM ordsrv
     ...
     LEFT JOIN cadven c ON c.dven_codvend_1 = ordsrv.orde_recepci_1
     LEFT JOIN apopro p ON p.opro_produti_1 = 0::numeric
     LEFT JOIN segcad s ON s.gcad_placvei_1::text = ordsrv.orde_placvei_1::text
     LEFT JOIN sintab21 ON sintab21.ntab_codmode_21::text = s.gcad_codmode_1::text
     LEFT JOIN sintab02 ON sintab02.ntab_codorig_2 = t24.ntab_departa_24
     LEFT JOIN notsais n ON n.tser_numorde_1 = ordsrv.orde_nrordem_1 AND n.tser_emitent_1 = ordsrv.orde_emitent_1
  WHERE (( SELECT count(*) AS count
           FROM ordsrvi
          WHERE ordsrvi.ordi_emitent_1 = ordsrv.orde_emitent_1 AND ordsrvi.ordi_nrordem_1 = ordsrv.orde_nrordem_1)) = 0 AND (( SELECT count(*) AS count
           FROM ordsrvs
          WHERE ordsrvs.ords_emitent_1 = ordsrv.orde_emitent_1 AND ordsrvs.ords_nrordem_1 = ordsrv.orde_nrordem_1)) = 0 AND ordsrv.orde_statord_1 <> 8;